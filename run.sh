...
echo "=== Phase 4: train-derived threshold check (DECISIONS.md D29, D30) ==="
python3 src/phase4_train_derived_thresholds.py

echo "=== Phase 4: README presentation figures (DECISIONS.md D22, D30) ==="
