#!/usr/bin/env bash
# Reproduces every number reported so far (Phase 0 + Phase 1 features).
# Extended as later phases land -- see README.md (once written) for the
# final, authoritative version of this file.
set -euo pipefail
cd "$(dirname "$0")"
